...
//        holder.setTypeface(Typeface.createFromAsset(getAssets(), "fonts/english.ttf"));
        ...
        holder.getView<LinearLayout>(R.id.searched_word_item_holder_root).setOnClickListener(null)

        var line = holder.getView<LinearLayout>(R.id.searched_word_item_holder)
        line.setTag(R.id.searched_word_item_holder, item)
        line.setOnClickListener(itemClickListener)
//        if (item.collect) {
