...
class PracticeDataLoader : DataLoader {
    ...
    private fun loadTextBook1(roomDb: RoomDB) {
        ...
        var book1 = PracticeBook(
            ...
            mutableListOf(
                PracticeSection(name = "第1单元").bindId(6).bindTemplatesDbToThis(
                    mutableListOf(
                        PracticeTemplate(
                            category = "单句填空",
                ...
                PracticeSection(name = "第2单元").bindId(7).bindTemplatesDbToThis(mutableListOf()),
                PracticeSection(name = "第3单元").bindId(8).bindTemplatesDbToThis(mutableListOf()),
                PracticeSection(name = "第4单元").bindId(9).bindTemplatesDbToThis(mutableListOf()),
                PracticeSection(name = "第5单元").bindId(10).bindTemplatesDbToThis(mutableListOf()),
                PracticeSection(name = "期中测试").bindId(11).bindTemplatesDbToThis(mutableListOf()),
                PracticeSection(name = "期末测试").bindId(12).bindTemplatesDbToThis(mutableListOf()),
            )
        )
